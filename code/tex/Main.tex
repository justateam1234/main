...
\item 
Assumed that the fishing and netting time of Scottish vessel around two hours each time.
...
$T_0$     & The time spent in fishing and boating of a Scottish vessel      \\
$T_1$     & The time spent in sailing of a Scottish vessel      \\
$T_2$       & Fish preservation time at ambient temperature        \\
$T_3$     & The time spent in sailing  of a Scottish vessel      \\
$T_{annual}$     & The annual average temperature      \\
...
$n$      & The number  of  crews in ferries \\
 ...
 \subsection{The varying temperature model}
  ...
  \subsubsection{The yearly change prediction model}
    ...
    \begin{figure}[htbp]
      \centering{
      \includegraphics[width=0.8\textwidth]{image/predic_log.eps}}
      \caption{using logistic model}\label{figure1}
    \end{figure}
    \begin{figure}[htbp]
      \centering{
      \includegraphics[width=0.8\textwidth]{image/predic_qua.eps}}
...
\begin{figure}[htbp]
  \centering{
  \includegraphics[width=0.5\textwidth]{picture/maxprofit_year_relation_change_port.eps}}
  \caption{Oslo profit graph}
\end{figure}
