...
$T_0$   &Time for fishing and netting \\
...
\subsection{The prediction of fish accumutation distribution}
  ...
  \begin{figure}[htbp]
    ...
    \subfigure[fish gathering area after 0 years]{
    \begin{minipage}[t]{0.5\linewidth}
    \centering
    ...
    \subfigure[fish gathering areas after 10 years]{
    \begin{minipage}[t]{0.5\linewidth}
    \centering
    ...
    \quad
    \subfigure[fish gathering areas after 25 years]{
    \begin{minipage}[t]{0.5\linewidth}
    \centering
    ...
    \subfigure[fish gathering areas after 50 years]{
    \begin{minipage}[t]{0.5\linewidth}
    \centering
  ...
  \begin{figure}[htbp]
    \centering{
    \includegraphics[width=0.9\textwidth]{image/fishpath.eps}}
...
\left\{
\begin{array}{lr}
V_o=r_o \times P \times ( T_1+T_0)\times a_o &\\
a_o=0.8&\\
p_o=0.5&\\
A_3=V_o  \times p_o\\
\end{array}
...
Due to the limitation of fish preservation time,  Scotland small company can make a large profit offshore. From the comparison about the offshore distance and income (e), it can be concluded that when the distance is less than 200 kilometers, the company's profit is positively related to the density of the local fish school. There are obvious differences in various years, because the fish school moves northward with the change in temperature. As can be seen from the figure (f) that after about 40 years, the net profit will drop to 0. Therefore, these small companies should take measures in advance to deal with changes in fish stocks.
  ...
  % \begin{figure}[htbp]
  %   \centering
    \subfigure[the elapsed time for the best case]{
    \begin{minipage}[t]{0.5\linewidth}
    \centering
    \includegraphics[width=3in]{image/eleptime_bestcase.eps}
    %\caption{fig1}
    \end{minipage}%
    }%
    \subfigure[the elapsed time for the worst case]{
    \begin{minipage}[t]{0.5\linewidth}
    \centering
    \includegraphics[width=3in]{image/eleptime_worstcase.eps}
    %\caption{fig2}
    \end{minipage}%
    } 
    \centering
...
A_1=c_3 \times ( T_1+T_0\times L \times (1+10\%) &\\
A_2=c_2  \times ( T_1+T_0) \times L \times  \frac{1}{2} &\\
A_3=V_o  \times P_o &\\
A=A_1+A_2+A_3+A_e \\		
			\end{array}
			\right.
...
as is shown in Figure ~\ref{figure1}.
 ...
 (CEP)\cite{Murray2013Evacuation,Ng2015Sharp,Ng2010Reliable}
...
Among the world's four major fisheries, Newfoundland fisheries have long since lost due to over-fishing. Peruvian fisheries focus on Peruvian catfish that have a poor taste and are mainly used as fodder. Beihai fishing grounds nourished most of Europe, but in recent years the types of Beihai fishing grounds have gradually decreased. 
...
As you taste canned herring in Scotland, do not forget to thank these little cute lives!
